...
//        Camera.Size optimalSize = getOptimalPreviewSize(sizes, w, h);
                ...
                sendBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (lastLocation != null)
                            new SendPhotoAsyncTask(MainActivity.this, sharedPreferences.getString("install", UUID.randomUUID().toString()), lastLocation.getLongitude(), lastLocation.getLatitude(), (String) imageView.getTag(), editText.getText().toString(), new File(param[0])).execute();
                        else
    ...
    public void onConnected(Bundle bundle) {
        ...
        Toast.makeText(this, "Location aquired", Toast.LENGTH_LONG).show();
    }
